...
def generate_card_pdf(template_file, sequence_filename, df, comments):
    ...
    with open(template_file) as f:
        tex = f.read()
    tex = latex.render_templated_tex(tex, BatchID=batch_id, Date=date, Filename=sequence_filename, df=df, Comments=comments)
