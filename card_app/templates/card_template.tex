...
\begin{document}
	...
	\adjustbox{minipage=\linewidth}{
		\noindent\LARGE{\textbf{\VAR{Sequence.comments.Project}}}\\
		\VAR{Sequence.comments.Researcher} \hfill \textbf{\VAR{Sequence.batch_id}}\\
...
%	\end{figure}
	...
	\adjustbox{minipage=\linewidth}{
		\begin{tabular}{|p{1.6cm}|p{1.6cm}|p{1.6cm}|p{1.6cm}|p{1.6cm}|}
		 \hline
		 Created: \textbf{\VAR{Sequence.date.strftime('%d.%m.%Y').replace('.', ' ')}} & {\color{lightgray}Planned Start} & {\color{lightgray}Date Queued} & {\color{lightgray}Date Started} & {\color{lightgray}Date Done}\\
		 \hline
		\end{tabular}
	}
