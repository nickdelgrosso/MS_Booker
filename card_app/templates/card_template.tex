...
\begin{landscape}
	...
	\noindent
	\adjustbox{minipage=0.45\textheight,rotate=90,valign=m}{
		\noindent\textbf{\VAR{Comments.Project}}\\
	...
	\adjustbox{minipage=0.9\linewidth,valign=m}{
		\adjustbox{minipage=\textwidth,valign=m}{
			\adjustbox{minipage=0.3\linewidth,valign=m}{
		%		    \strut\vspace*{-\baselineskip}\newline
				\BLOCK{for name, val in Comments.items()}
					\textbf{\VAR{name | replace("_", "\_")}}: \VAR{val | replace("_", "\_") | truncate(25)} \\
				\BLOCK{endfor}
			}
			...
			\fbox{\adjustbox{minipage=[b][6cm][s]{0.15\linewidth}}{
